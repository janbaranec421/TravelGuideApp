var SideMenu = (function () {
    ...
    SideMenu.prototype.loadProjectFromJSON = function (ID) {
        ...
        $.getJSON("../Resources/project-" + ID + ".json", function (projectData) {
        ...
        listItem.filter("a:contains('Schedules')")
            .click(function () { window.location.href = "schedules.html"; })
            .parent().click(function () {
            $("#sideMenu > ul > ul").stop(true, true).slideUp(300);
        });
        // [Open/Close] submenu for Collections
        listItem.filter("a:contains('Collections')").parent().click(function () {
            $("#collectionsSubMenu").stop(true, true).slideToggle(300);
        });
        // [Open/Close] submenu for Tags
        listItem.filter("a:contains('Tags')").parent().click(function () {
